// AuthViewModel est le BLoC qui gère l'état de l'authentification (login, register, logout, update profile/password). 
//Il utilise AuthManager pour la logique métier et expose des événements et états pour la UI.
